...
#ifndef CROCODDYL_MULTIBODY_RESIDUALS_FLY_HIGH_EXP_HPP_
#define CROCODDYL_MULTIBODY_RESIDUALS_FLY_HIGH_EXP_HPP_
...
class ResidualModelFlyHighExpTpl: public ResidualModelAbstractTpl<_Scalar> {
public:
    ...
    typedef ResidualDataFlyHighExpTpl<Scalar> Data;
    ...
    ResidualModelFlyHighExpTpl(boost::shared_ptr<StateMultibody> state,
                               const std::size_t nu,
    ...
    */
    ...
    virtual ~ResidualModelFlyHighExpTpl();
...
template <typename _Scalar>
struct ResidualDataFlyHighExpTpl : public ResidualDataAbstractTpl<_Scalar> {
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    ...
    ResidualDataFlyHighExpTpl(Model <Scalar> *const model, DataCollectorAbstract *const data)
            :   Base(model, data),
...
#include "crocoddyl/multibody/residuals/fly-high-exp.hxx"

#endif //CROCODDYL_MULTIBODY_RESIDUALS_FLY_HIGH_EXP_HPP_